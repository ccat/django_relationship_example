...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field targets on 'ManyToManyClass'
        m2m_table_name = db.shorten_name(u'django_relationship_example_manytomanyclass_targets')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field targets on 'ManyToManyClass'
        db.delete_table(db.shorten_name(u'django_relationship_example_manytomanyclass_targets'))
    ...
    models = {
        ...
        u'django_relationship_example.manytomanyclass': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'null': 'True', 'blank': 'True'}),
            'targets': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'many_to_many'", 'symmetrical': 'False', 'to': u"orm['django_relationship_example.TargetClass']"})
        },
